...
openssl x509 -req -in server.csr -CA ca.crt -CAkey ca.key -CAcreateserial -passin pass:123456 -extensions v3_req -set_serial 03 -extfile openssl.cnf -out server.crt
...
openssl x509 -req -in client.csr -CA ca.crt -CAkey ca.key -CAcreateserial -passin pass:123456 -extensions v3_req -set_serial 03 -extfile openssl.cnf -out client.crt
